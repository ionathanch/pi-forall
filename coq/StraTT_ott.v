...
Inductive DSig : signature -> Prop :=    (* defn DSig *)
 | D_Empty : 
     DSig  nil 
 | D_Cons : forall (S:signature) (x:var) (A:tm) (j:nat) (a:tm) (k:nat),
     DSig S ->
...
with DCtx : signature -> context -> Prop :=    (* defn DCtx *)
 | DG_Empty : forall (S:signature),
     DSig S ->
     DCtx S  nil 
 | DG_Cons : forall (S:signature) (G:context) (x:var) (A:tm) (j k:nat),
     DCtx S G ->
...
with DTyping : signature -> context -> tm -> tm -> nat -> Prop :=    (* defn DTyping *)
 ...
 | DT_Pi : forall (L:vars) (S:signature) (G:context) (A:tm) (i:nat) (B:tm) (k:nat),
     DTyping S G A a_Type k ->
      ( forall x , x \notin  L  -> DTyping S  (  ( x ~ (Tm A i) )  ++ G )   ( open_tm_wrt_tm B (a_Var_f x) )  a_Type k )  ->
      i  <  k  ->
     DTyping S G (a_Pi A i B) a_Type k
 ...
 | DT_AbsTy : forall (L:vars) (S:signature) (G:context) (b A:tm) (i:nat) (B:tm) (j k:nat),
     DTyping S G A a_Type k ->
      ( forall x , x \notin  L  -> DTyping S  (  ( x ~ (Tm A i) )  ++ G )   ( open_tm_wrt_tm B (a_Var_f x) )  a_Type k )  ->
      ( forall x , x \notin  L  -> DTyping S  (  ( x ~ (Tm A i) )  ++ G )   ( open_tm_wrt_tm b (a_Var_f x) )   ( open_tm_wrt_tm B (a_Var_f x) )  j )  ->
      i  <  k  ->
      j  <=  k  ->
     DTyping S G (a_Abs b) (a_Pi A i B) j
 | DT_AppTm : forall (S:signature) (G:context) (b a B:tm) (k:nat) (A:tm),
     DTyping S G b (a_Arrow A B) k ->
     DTyping S G a A k ->
     DTyping S G (a_App b a) B k
 | DT_AppTy : forall (S:signature) (G:context) (b a B:tm) (j:nat) (A:tm) (i:nat),
     DTyping S G b (a_Pi A i B) j ->
     DTyping S G a A i ->
     DTyping S G (a_App b a)  (open_tm_wrt_tm  B   a )  j
 | DT_Bottom : forall (S:signature) (G:context) (k:nat),
     DCtx S G ->
     DTyping S G a_Bottom a_Type k
 | DT_Absurd : forall (S:signature) (G:context) (b A:tm) (j k:nat),
     DTyping S G A a_Type k ->
     DTyping S G b a_Bottom j ->
      j  <=  k  ->
     DTyping S G (a_Absurd b) A j
 | DT_Conv : forall (S:signature) (G:context) (a B:tm) (j:nat) (A:tm) (k:nat),
     DTyping S G a A j ->
     DTyping S G B a_Type k ->
     DEquiv S A B ->
      j  <=  k  ->
